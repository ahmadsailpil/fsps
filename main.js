...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6283160327945@s.whatsapp.net`, {text: 'BERHASIL TERSAMBUNG KE BOT ✿FSPS✿ JANGAN LUPA SAVE OHLX, PASTI DI SAVEBACK' })
}
